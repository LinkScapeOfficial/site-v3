  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center mt-12 sm:mt-60 sm:mb-64 mb-20">
        <div
          className="absolute inset-0 grid grid-cols-2 -space-x-12 sm:-space-x-52 opacity-40 dark:opacity-20"
          style={{ zIndex: -1 }}
        >
        ...
        <div className="flex flex-wrap">
          <Link
            ...
            className="mr-6 hover:-translate-y-1 transition-transform duration-300"
          >
